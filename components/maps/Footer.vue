...
onMounted(() => {
  ...
  loadScript(`https://unpkg.com/@googlemaps/extended-component-library@0.6`, 'script')
      .then(() => {
        return loadScript(`https://maps.googleapis.com/maps/api/js?key=${process.env.GOOGLE_MAPS_API_KEY || 'AIzaSyCqfYBHSSatxDzAt9kU3IFFVyTk2BmaZzI'}&libraries=places,marker&v=beta`, 'script')
      })
      .then(() => {
