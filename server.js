...
const checkCollectionExists = async () => {
    try {
        ...
        console.log(chalk.green('Products collection is accessible and contains data.'));
        return true;
    } catch (error) {
...
const startApolloServer = async () => {
    ...
    if (!isCollectionAccessible) {
        console.error(chalk.red('Cannot proceed, products collection is not accessible.'));
        return;
    }
